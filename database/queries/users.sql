...
SELECT * FROM users WHERE email = 'aarav.sharma@youruniversity.edu';

-- New emails must be lower-case and use the campus domain.
INSERT INTO users (auth_user_id, name, email)
VALUES ('10000000-0000-4000-8000-000000000001', 'New Student', 'new.student@youruniversity.edu');

-- Expected failures (keep each in a rolled-back transaction).
BEGIN;
INSERT INTO users (auth_user_id, name, email)
VALUES ('10000000-0000-4000-8000-000000000002', 'Duplicate', 'aarav.sharma@youruniversity.edu');
ROLLBACK;
